      ...
      <SidebarWrapper>
        ...
        >
          ...
          >
            ...
            >
              <Menu.Item key="JanagananaForm">
                <Link to={`${url}/JanagananaForm`}>
                  <span className="isoMenuHolder" style={submenuColor}>
                    <i className="ion-android-mail" />
                    <span className="nav-text">
                      <IntlMessages id="sidebar.JanagananaForm" />
                    </span>
                  </span>
                </Link>
              </Menu.Item>

              <Menu.Item key="ManageMatrimonial">
                <Link to={`${url}/ManageMatrimonial`}>
                  <span className="isoMenuHolder" style={submenuColor}>
                    <i className="ion-android-mail" />
                    <span className="nav-text">
                      <IntlMessages id="sidebar.ManageMatrimonial" />
                    </span>
                  </span>
                </Link>
              </Menu.Item>
              <Menu.Item key="KundaliInformationForm">
                <Link to={`${url}/KundaliInformationForm`}>
                  <span className="isoMenuHolder" style={submenuColor}>
                    <i className="ion-android-mail" />
                    <span className="nav-text">
                      <IntlMessages id="sidebar.KundaliInformationForm" />
                    </span>
                  </span>
                </Link>
              </Menu.Item>
              <Menu.Item key="CareerInformationForm">
                <Link to={`${url}/CareerInformationForm`}>
                  <span className="isoMenuHolder" style={submenuColor}>
                    <i className="ion-android-mail" />
                    <span className="nav-text">
                      <IntlMessages id="sidebar.CareerInformationForm" />
                    </span>
                  </span>
                </Link>
              </Menu.Item>
